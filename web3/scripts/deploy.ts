...
interface DeployedContract {
    address: string;
    connect(signerOrProvider: any): DeployedContract;
    deployed(): Promise<DeployedContract>;
}

return await contractFactory.deploy(...params).then((f: DeployedContract) => f.deployed());
}
